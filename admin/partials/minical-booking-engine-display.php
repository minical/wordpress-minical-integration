                            ...
                            <form class="form-horizontal" method="post" action="" autocomplete="off">
                                ...
                                <div class="form-group">
                                    <label for="website_uri" class="col-sm-4 control-label">
                                        ...
                                        <p class="help-block h6"><?php echo "To enable this feature, at least one  payment gateway must be enabled on Minical"; ?></p></p>
                                    </label>
        ...
        <?php } else { ?>
            ...
            <div class="main-wrp form_creation_div clearfix">
                <div class="row">
                    <div class="col-md-3"></div>
                    <div class="col-md-6">
                        <h3 class="text-center">You have to signup/login with minical first.</h3>
                    </div>
                </div>
            </div>
        <?php } ?>
